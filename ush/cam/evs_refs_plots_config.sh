...
#                   clone the Github repository. Or if on the NOAA WCOSS supercomputer, choose any 
#                   directory that will house verif_plotting.  As an example, we'll call that 
#                   directory PY_PLOT_DIR.  Then on the command line:
#
