#!/bin/bash -e
# cam_submit_mail_messages.sh
# CONTRIBUTORS: Marcel Caron, marcel.caron@noaa.gov
# ----------------------
# Submits mail messages to the MAILTO mailing list for the cam component.
#
# Environment Variables (Inputs):
#     DATA, COMPONENT, jobid, MAILTO
#     (and other variables required for mail message creation)
#
# Outputs:
#     - Sends mail messages for different job types (gen, fcst, anl) if present.
#     - Prints errors and exits if required environment variables or files are missing.
#
# This script is intended to be run as part of the cam component to automate
# submission of mail messages generated by other scripts.
