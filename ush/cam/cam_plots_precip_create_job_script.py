#!/usr/bin/env python3
"""
cam_plots_precip_create_job_script.py
CONTRIBUTORS: Marcel Caron, marcel.caron@noaa.gov
----------------------
Creates job scripts for EVS CAM Precip plots in the cam component.
...
Outputs:
    - Generates job scripts for plotting Precip statistics.
...
creation of plotting job scripts for Precip verification.
"""
...
SPATIAL_MAPS_OUTPUT_BASE_DIR = os.environ['SPATIAL_MAPS_OUTPUT_BASE_DIR']
...
job_env_vars_dict = {
    ...
    'SPATIAL_MAPS_OUTPUT_BASE_DIR': SPATIAL_MAPS_OUTPUT_BASE_DIR,
