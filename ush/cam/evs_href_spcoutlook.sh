...
mask_day1=${EVSINspcotlk:0:$index}/cam/$RUN.$day1/spc_otlk.$day1
mask_day2=${EVSINspcotlk:0:$index}/cam/$RUN.$day2/spc_otlk.$day2
mask_day3=${EVSINspcotlk:0:$index}/cam/$RUN.$day3/spc_otlk.$day3
