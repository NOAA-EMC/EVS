...
class LeadAverageVhrMean:
    ...
    def make_lead_average_vhr_mean(self):
        ...
        if include_difference_plot:
            ...
            plot_specs_la = PlotSpecs(self.logger, 'lead_average_no_diffplot')
        ...
        if include_difference_plot:
            ...
            fig, ax1 = plt.subplots(1,1,figsize=(plot_specs_la.fig_size[0],
                                            plot_specs_la.fig_size[1] ))
        ...
        if include_difference_plot:
            ...
            ax1.set_xlim([self.date_info_dict['forecast_hours'][0],
                          self.date_info_dict['forecast_hours'][-1]])
