...
Run By: individual plotting job scripts generated through
        ush/cam/cam_rrfs_chem_plots_grid2obs_create_job_scripts.py
'''
...
if JOB_GROUP == 'condense_stats':
    ...
    met_info_dict = original_met_info_dict.copy()
    if plot == 'time_series':
        import cam_rrfs_chem_plots_time_series as gdap_ts
        ...
        import cam_rrfs_chem_plots_time_series_fhr_mean as gdap_tsfm
        logger.info(f"cam_rrfs_chem_plots.py process time_series_fhr_mean")
        date_info_dict['fday_start'] = fday_start
        date_info_dict['fday_end'] = fday_end
        date_info_dict['fday_inc'] = fday_inc
        plot_info_dict['fig_name_label'] = fig_name_label
        ...
        import cam_rrfs_chem_plots_lead_average as gdap_la
        current_var=var_info[0][0][0]
        ...
        import cam_rrfs_chem_plots_lead_average_vhr_mean as gdap_lavm
        date_info_dict['fday_start'] = fday_start
        date_info_dict['fday_end'] = fday_end
        date_info_dict['fday_inc'] = fday_inc
        plot_info_dict['fig_name_label'] = fig_name_label
        ...
        import cam_rrfs_chem_plots_valid_hour_average as gdap_vha
        current_var=var_info[0][0][0]
        ...
        import cam_rrfs_chem_plots_valid_hour_average_fhr_mean as gdap_vhafm
        date_info_dict['fday_start'] = fday_start
        date_info_dict['fday_end'] = fday_end
        date_info_dict['fday_inc'] = fday_inc
        plot_info_dict['fig_name_label'] = fig_name_label
        ...
        import cam_rrfs_chem_plots_threshold_average as gdap_ta
        current_var=var_info[0][0][0]
        ...
        import cam_rrfs_chem_plots_threshold_average_fhrvhr_mean as gdap_tafvm
        date_info_dict['fday_start'] = fday_start
        date_info_dict['fday_end'] = fday_end
        date_info_dict['fday_inc'] = fday_inc
        plot_info_dict['fig_name_label'] = fig_name_label
        ...
        ## Original global_det_setting is one fcst hr for one valid hr
        import cam_rrfs_chem_plots_performance_diagram as gdap_pd
        current_var=var_info[0][0][0]
