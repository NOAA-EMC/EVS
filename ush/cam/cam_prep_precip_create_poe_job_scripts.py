#!/usr/bin/env python3
"""
cam_prep_precip_create_poe_job_scripts.py
CONTRIBUTORS: Marcel Caron, marcel.caron@noaa.gov, NOAA/NWS/NCEP/EMC-VPPPGB
----------------------
Creates EVS CAM Precipitation POE job scripts for the cam component, using
...
the creation and management of POE job scripts for precipitation processing.
"""
