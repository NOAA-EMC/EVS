#!/usr/bin/env python3
"""
cam_stats_snowfall_create_poe_job_scripts.py
CONTRIBUTORS: Marcel Caron, marcel.caron@noaa.gov
----------------------
Creates POE job scripts for Snowfall verification in the cam component.
...
Outputs:
    - Generates POE job scripts for running Snowfall verification in parallel.
...
creation of POE job scripts for Snowfall verification.
"""
