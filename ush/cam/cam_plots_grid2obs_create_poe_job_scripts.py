#!/usr/bin/env python3
"""
cam_plots_grid2obs_create_poe_job_scripts.py
CONTRIBUTORS: Marcel Caron, marcel.caron@noaa.gov
----------------------
Creates POE (parallel execution) job scripts for EVS CAM Grid2Obs plots in the
cam component.
...
creation of POE job scripts for Grid2Obs plotting.
"""
