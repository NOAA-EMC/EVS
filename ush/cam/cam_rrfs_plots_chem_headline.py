#!/usr/bin/env python3
'''
Name: cam_rrfs_plots_chem_headline.py
Contact(s): Ho-Chun Huang (ho-chun.huang@noaa.gov)
Abstract: This is the driver script for creating headline plots.
Run By: scripts/plots/cam/exevs_plots_global_chem_headline_grid2obs.sh
'''
...
for headline_type in input_obs_types:
    ...
    if headline_type == "pm25":
        ...
        headline1_job_name = (
            ...
            +'fday'+headline1_date_info_dict['fday_start']+'_'
        ...
        import cam_rrfs_chem_plots_time_series_fhr_mean as gdap_ts
        plot_ts = gdap_ts.TimeSeriesFhrMean(logger1, headline1_output_dir,
        ...
        icnt += 1
        ### Headline Score Plot : Grid-to-OBS - AERONET AOD observations CONUS 
        ###                                      Last 90 days 12Z CYCLE DAY2 FCST 
        print("\nHeadline Score Plot "+str(icnt)+" : Grid-to-OBS - AERONET AOD observations CONUS "
              +"Last 90 days 12Z CYCLE DAY2 FCST")
        # Set fixed plot values
        headline1_plot = 'time_series'
        headline1_ndays = 90
