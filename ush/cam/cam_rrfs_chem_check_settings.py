...
evs_cam_rrfs_chem_settings_dict = {}
if evs_run_mode == 'production':
    evs_cam_rrfs_chem_settings_dict['evs'] = [
...
evs_cam_rrfs_chem_settings_dict['RUN_GRID2OBS_PLOTS'] = [
...
verif_case_step_settings_dict = {
    ...
    'RUN_GRID2OBS_PLOTS': {
        ...
        'pm10': ['init_hr_list', 'valid_hr_list', 'fhr_list'],
        'aod': ['init_hr_list', 'valid_hr_list', 'fhr_list']
    }
}
...
for env_check_group in env_check_group_list:
    env_var_check_list = (
        evs_cam_rrfs_chem_settings_dict[env_check_group]
    )
