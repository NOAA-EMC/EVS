...
graphics = {
    'cam':{
        'headline':{
            'metar':{
                'set1, rrfs, namnest, hireswarw, hireswarwmem2, hireswfv3, hrrr': {
                    'lead_average':{
                        'DATE_TYPE':'INIT',
                        'VALID_BEG':'',
                        'VALID_END':'',
                ...
                'set2, rrfs, namnest, hireswarw, hireswarwmem2, hireswfv3, hrrr': {
                    'lead_average':{
                        'DATE_TYPE':'INIT',
                        'VALID_BEG':'',
                        'VALID_END':'',
                ...
                'set3, rrfs, namnest, hireswarw, hireswarwmem2, hireswfv3, hrrr': {
                    'lead_average':{
                        'DATE_TYPE':'INIT',
                        'VALID_BEG':'',
                        'VALID_END':'',
                ...
                'set4, rrfs, namnest, hireswarw, hireswarwmem2, hireswfv3': {
                    'lead_average':{
                        'DATE_TYPE':'INIT',
                        'VALID_BEG':'',
                        'VALID_END':'',
