...
for plot in plots_list:
    ...
    if plot == 'time_series':
        import refs_atmos_plots_time_series as gdap_ts
        for ts_info in \
        ...
        import refs_atmos_plots_lead_average as gdap_la
        for la_info in \
        ...
        import refs_atmos_plots_valid_hour_average as gdap_vha
        for vha_info in \
        ...
        import refs_atmos_plots_threshold_average as gdap_ta
        for ta_info in \
        ...
        import refs_atmos_plots_lead_by_date as gdap_lbd
        for lbd_info in \
                list(itertools.product(valid_hrs, var_info,
                                       interp_points_list)):
        ...
        import refs_atmos_plots_stat_by_level as gdap_sbl
        ...
        import refs_atmos_plots_lead_by_level as gdap_lbl
        ...
        import refs_atmos_plots_nohrsc_spatial_map as gdap_nsm
        ...
        import refs_atmos_plots_performance_diagram as gdap_pd
        for pd_info in \
                list(itertools.product(valid_hrs, fhrs, interp_points_list)):
