                ...
                'NBRCNT': {
                    ...
                    'var_dict': {
                        ...
                        'APCP_24': {'fcst_var_names': ['APCP', 'APCP_24'],
                                    ...
                                    'obs_var_options': '',
                                    'plot_group':'precip'},
                        'APCP24_gt1': {'fcst_var_names': ['APCP', 'APCP_24'],
                                       'fcst_var_levels': ['A24'],
                                       'fcst_var_thresholds': '>1',
                                       'fcst_var_options': '',
                                       'obs_var_names': ['APCP', 'APCP_24', 'APCP_01_Z0'],
                                       'obs_var_levels': ['A24'],
                                       ...
                                       'obs_var_options': '',
                                       'plot_group':'precip'},
                        'APCP24_gt5': {'fcst_var_names': ['APCP', 'APCP_24'],
                                       'fcst_var_levels': ['A24'],
                                       'fcst_var_thresholds': '>5',
                                       'fcst_var_options': '',
                                       'obs_var_names': ['APCP', 'APCP_24', 'APCP_01_Z0'],
                                       'obs_var_levels': ['A24'],
                                       ...
                                       'obs_var_options': '',
                                       'plot_group':'precip'},
                        'APCP24_gt10': {'fcst_var_names': ['APCP', 'APCP_24'],
                                        'fcst_var_levels': ['A24'],
                                        ...
                                        'obs_var_options': '',
                                        'plot_group':'precip'},
                        'APCP24_gt25': {'fcst_var_names': ['APCP', 'APCP_24'],
                                        'fcst_var_levels': ['A24'],
                                        'fcst_var_thresholds': '>25',
                                        'fcst_var_options': '',
                                        'obs_var_names': ['APCP', 'APCP_24', 'APCP_01_Z0'],
                                        'obs_var_levels': ['A24'],
                                        ...
                                        'obs_var_options': '',
                                        'plot_group':'precip'},
                        'APCP24_gt50': {'fcst_var_names': ['APCP', 'APCP_24'],
                                        'fcst_var_levels': ['A24'],
                                        'fcst_var_thresholds': '>50',
                                        'fcst_var_options': '',
                                        'obs_var_names': ['APCP', 'APCP_24', 'APCP_01_Z0'],
                                        'obs_var_levels': ['A24'],
                        ...
                        'WEASD_24': {'fcst_var_names': ['WEASD_L0'],
                                    ...
                                    'obs_var_options': '',
                                    'plot_group':'precip'},
                        'WEASD_24_gt0p0254': {'fcst_var_names': ['WEASD_L0'],
                                              'fcst_var_levels': ['L0'],
                                              'fcst_var_thresholds': '>0.0254',
                                              'fcst_var_options': '',
                                              'obs_var_names': ['ASNOW'],
                                              'obs_var_levels': ['A24'],
                                              'obs_var_thresholds': '>0.0254',
                                              'obs_var_options': '',
                                              'plot_group':'precip'},
                        'WEASD_24_gt0p1016': {'fcst_var_names': ['WEASD_L0'],
                                              'fcst_var_levels': ['L0'],
                                              'fcst_var_thresholds': '>0.1016',
                                              'fcst_var_options': '',
                                              'obs_var_names': ['ASNOW'],
                                              'obs_var_levels': ['A24'],
                                              'obs_var_thresholds': '>0.1016',
                                              'obs_var_options': '',
                                              'plot_group':'precip'},
                        'WEASD_24_gt0p2032': {'fcst_var_names': ['WEASD_L0'],
                                              'fcst_var_levels': ['L0'],
                                              'fcst_var_thresholds': '>0.2032',
                                              'fcst_var_options': '',
                                              'obs_var_names': ['ASNOW'],
                                              'obs_var_levels': ['A24'],
                                              'obs_var_thresholds': '>0.2032',
                                              'obs_var_options': '',
                                              'plot_group':'precip'},
                        'WEASD_24_gt0p3048': {'fcst_var_names': ['WEASD_L0'],
                                              'fcst_var_levels': ['L0'],
                                              'fcst_var_thresholds': '>0.3048',
                                              'fcst_var_options': '',
                                              'obs_var_names': ['ASNOW'],
                                              'obs_var_levels': ['A24'],
                                              'obs_var_thresholds': '>0.3048',
                                              'obs_var_options': '',
                                              'plot_group':'precip'},
                        'SNOD_24': {'fcst_var_names': ['SNOD_L0'],
                                    ...
                                    'obs_var_options': '',
                                    'plot_group':'precip'},
                        'SNOD_24_gt0p0254': {'fcst_var_names': ['SNOD_L0'],
                                             'fcst_var_levels': ['L0'],
                                             'fcst_var_thresholds': '>0.0254',
                                             'fcst_var_options': '',
                                             'obs_var_names': ['ASNOW'],
                                             ...
                                             'obs_var_options': '',
                                             'plot_group':'precip'},
                        'SNOD_24_gt0p1016': {'fcst_var_names': ['SNOD_L0'],
                                             'fcst_var_levels': ['L0'],
                                             'fcst_var_thresholds': '>0.1016',
                                             'fcst_var_options': '',
                                             'obs_var_names': ['ASNOW'],
                                             ...
                                             'obs_var_options': '',
                                             'plot_group':'precip'},
                        'SNOD_24_gt0p2032': {'fcst_var_names': ['SNOD_L0'],
                                             'fcst_var_levels': ['L0'],
                                             'fcst_var_thresholds': '>0.2032',
                                             'fcst_var_options': '',
                                             'obs_var_names': ['ASNOW'],
                                             ...
                                             'obs_var_options': '',
                                             'plot_group':'precip'},
                        'SNOD_24_gt0p3048': {'fcst_var_names': ['SNOD_L0'],
                                             'fcst_var_levels': ['L0'],
                                             'fcst_var_thresholds': '>0.3048',
                                             'fcst_var_options': '',
                                             'obs_var_names': ['ASNOW'],
                ...
                'CTC': {
                    ...
                    'var_dict': {
                       ...
                       'ICEC_gt40': {'fcst_var_names': ['ICEC_Z0_mean'],
                                     'fcst_var_levels': ['Z0'],
                                     'fcst_var_thresholds': '>40',
                                     'fcst_var_options':  '',
                                     'obs_var_names': ['ice_conc'],
                                     'obs_var_levels': ['*,*'],
                                     'obs_var_thresholds': '>40',
                                     'obs_var_options': '',
                                     'plot_group':'sfc_upper'},
                       'ICEC_gt80': {'fcst_var_names': ['ICEC_Z0_mean'],
                                     'fcst_var_levels': ['Z0'],
                                     'fcst_var_thresholds': '>80',
                                     'fcst_var_options':  '',
                                     'obs_var_names': ['ice_conc'],
                                     'obs_var_levels': ['*,*'],
                                     'obs_var_thresholds': '>80',
                                     'obs_var_options': '',
                                     'plot_group':'sfc_upper'},
                    }            
                }  
