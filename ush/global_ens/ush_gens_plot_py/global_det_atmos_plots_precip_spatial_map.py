        ...
        for model_num in self.model_info_dict:
            ...
            if make_plot:
                ...
                if model_num == 'obs': 
                    ...
                    precip_APCP_A24 = precip_data.variables['APCP_24_A24_ENS_MEAN'][:]
                    var_name = precip_data.variables['APCP_24_A24_ENS_MEAN'].getncattr('name')
                    var_level = precip_data.variables['APCP_24_A24_ENS_MEAN'].getncattr('level')
                    var_units = precip_data.variables['APCP_24_A24_ENS_MEAN'].getncattr('units')
                ...
                if model_num == 'obs':
                    ...
                    file_init_time = (precip_data.variables['APCP_24_A24_ENS_MEAN']\
                                  .getncattr('init_time'))
                    file_valid_time = (precip_data.variables['APCP_24_A24_ENS_MEAN']\
                                  .getncattr('valid_time'))
