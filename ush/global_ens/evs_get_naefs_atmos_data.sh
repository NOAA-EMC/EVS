...
#        2. For APCP24h, only retrieve bias-corrected GEFS files 
#        3. Stored the smaller grib2 files in prep/global_ens/atmos.YYYYMMDD/gefs_bc and 
#           prep/global_ens/atmos.YYYYMMDD/cmce_bc
#
# Updated: 06/02/2025 by L. Gwen Chen (lichuan.chen@noaa.gov)
...
#########################################
# Get GEFS 30 member grib2 files in grid3 
#########################################
  ...
  for ihour in $naefs_ihour ; do
	...
	if [ -s $gefs_bc ]; then
	  ...
	  for level in 250 850 ; do
            $WGRIB2 $gefs_bc | grep "UGRD:$level mb" | $WGRIB2 -i $gefs_bc -grib $WORKtask/grabgefs.${ihour}.${mb}.${hhh}
	    cat $WORKtask/grabgefs.${ihour}.${mb}.${hhh} >> $WORKtask/gefs.upper.${ihour}.${mb}.${hhh}
	    $WGRIB2 $gefs_bc | grep "VGRD:$level mb" | $WGRIB2 -i $gefs_bc -grib $WORKtask/grabgefs.${ihour}.${mb}.${hhh}
	    cat $WORKtask/grabgefs.${ihour}.${mb}.${hhh} >> $WORKtask/gefs.upper.${ihour}.${mb}.${hhh}
          done
	  
          $WGRIB2 $gefs_bc | grep "HGT:500 mb" | $WGRIB2 -i $gefs_bc -grib $WORKtask/grabgefs.${ihour}.${mb}.${hhh}
          cat $WORKtask/grabgefs.${ihour}.${mb}.${hhh} >> $WORKtask/gefs.upper.${ihour}.${mb}.${hhh}
	  $WGRIB2 $gefs_bc | grep "HGT:1000 mb" | $WGRIB2 -i $gefs_bc -grib $WORKtask/grabgefs.${ihour}.${mb}.${hhh}
	  cat $WORKtask/grabgefs.${ihour}.${mb}.${hhh} >> $WORKtask/gefs.upper.${ihour}.${mb}.${hhh}
	  ...
	  cat $WORKtask/grabgefs.${ihour}.${mb}.${hhh} >> $WORKtask/gefs.upper.${ihour}.${mb}.${hhh}
          ...
          if [ $SENDCOM="YES" ] ; then
            if [ -s $WORKtask/gefs_bc.ens${mb}.t${ihour}z.grid3.f${hhh}.grib2 ]; then 
              cp -v $WORKtask/gefs_bc.ens${mb}.t${ihour}z.grid3.f${hhh}.grib2 $COMOUTgefs_bc/gefs_bc.ens${mb}.t${ihour}z.grid3.f${hhh}.grib2
            fi
          fi
...
#########################################
# Get CMCE 20 member grib2 files in grid3 
#########################################
if [ $modnam = cmce_bc ] ; then
  ...
  for ihour in $naefs_ihour ; do
	...
	if [ -s $cmce_bc ]; then
          ...
          for level in 250 850 ; do
  	    $WGRIB2 $cmce_bc | grep "UGRD:$level mb" | $WGRIB2 -i $cmce_bc -grib $WORKtask/grabcmce.${ihour}.${mb}.${h3}
	    cat $WORKtask/grabcmce.${ihour}.${mb}.${h3} >> $WORKtask/cmce.upper.${ihour}.${mb}.${h3}
            $WGRIB2 $cmce_bc | grep "VGRD:$level mb" | $WGRIB2 -i $cmce_bc -grib $WORKtask/grabcmce.${ihour}.${mb}.${h3}
            cat $WORKtask/grabcmce.${ihour}.${mb}.${h3} >> $WORKtask/cmce.upper.${ihour}.${mb}.${h3}
	  done

          $WGRIB2 $cmce_bc | grep "HGT:500 mb" | $WGRIB2 -i $cmce_bc -grib $WORKtask/grabcmce.${ihour}.${mb}.${h3}
          cat $WORKtask/grabcmce.${ihour}.${mb}.${h3} >> $WORKtask/cmce.upper.${ihour}.${mb}.${h3}
          $WGRIB2 $cmce_bc | grep "HGT:1000 mb" | $WGRIB2 -i $cmce_bc -grib $WORKtask/grabcmce.${ihour}.${mb}.${h3}
	  cat $WORKtask/grabcmce.${ihour}.${mb}.${h3} >> $WORKtask/cmce.upper.${ihour}.${mb}.${h3}
	  ...
	  #****************************************************************************
	  $WGRIB2 $WORKtask/cmce.upper.${ihour}.${mb}.${h3} -set_grib_type same -new_grid_winds earth -new_grid ncep grid 003 $WORKtask/cmce_bc.ens${mb}.t${ihour}z.grid3.f${h3}.grib2

	  if [ $SENDCOM="YES" ] ; then
            if [ -s $WORKtask/cmce_bc.ens${mb}.t${ihour}z.grid3.f${h3}.grib2 ]; then
              cp -v $WORKtask/cmce_bc.ens${mb}.t${ihour}z.grid3.f${h3}.grib2 $COMOUTcmce_bc/cmce_bc.ens${mb}.t${ihour}z.grid3.f${h3}.grib2
            fi
          fi
...
if [ $modnam = gefs_bc_apcp24h ] ; then
  ...
  for ihour in $naefs_ihour ; do
	...
	if [ -s $apcp24_bc ]; then
          $WGRIB2 $apcp24_bc | grep -w "ENS=+${mbr}" | $WGRIB2 -i $apcp24_bc -grib $WORKtask/grabmbr.${ihour}.${hhh}
          $WGRIB2 $WORKtask/grabmbr.${ihour}.${hhh} -set_grib_type same -new_grid_winds earth -new_grid ncep grid 003 $WORKtask/gefs_bc.ens${mb}.t${ihour}z.grid3.24h.f${hhh}.grib2

	  if [ $SENDCOM="YES" ] ; then
            if [ -s $WORKtask/gefs_bc.ens${mb}.t${ihour}z.grid3.24h.f${hhh}.grib2 ]; then
              cp -v $WORKtask/gefs_bc.ens${mb}.t${ihour}z.grid3.24h.f${hhh}.grib2 $COMOUTgefs_bc/gefs_bc.ens${mb}.t${ihour}z.grid3.24h.f${hhh}.grib2
            fi
          fi
