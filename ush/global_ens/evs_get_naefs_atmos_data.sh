      ...
      mbr=1
       while [ $mbr -le $total ] ; do
	     ...
	     cat $WORK/grabgefs.${ihour}.${mb}.${hhh} >> $WORK/gefs.upper.${ihour}.${mb}.${hhh}
            ...
            $wgrib2 $WORK/gefs.upper.${ihour}.${mb}.${hhh} -set_grib_type same -new_grid_winds earth -new_grid ncep grid 003  $outdata/gefs_bc.ens${mb}.t${ihour}z.grid3.f${hhh}.grib2
     ...
     for ihour in $naefs_ihour ; do
       ...
       while [ $mbr -le $total ] ; do
		...
		cat $WORK/grabcmce.${ihour}.${mb}.${h3} >> $WORK/cmce.upper.${ihour}.${mb}.${h3}
	     ...
	     $wgrib2 $WORK/cmce.upper.${ihour}.${mb}.${h3} -set_grib_type same -new_grid_winds earth -new_grid ncep grid 003  $outdata/cmce_bc.ens${mb}.t${ihour}z.grid3.f${h3}.grib2
	...
	>$WORK/grabmbr.${ihour}.${hhh}
        ...
        for mbr in $mbrs ; do
	     ...
	     apcp24_bc=$origin/geprcp.t${ihour}z.pgrb2a.0p50.bc_24hf${hhh}
          ...
          $wgrib2 $WORK/grabmbr.${ihour}.${hhh} -set_grib_type same -new_grid_winds earth -new_grid ncep grid 003  $outdata/gefs_bc.ens${mb}.t${ihour}z.grid3.24h.f${hhh}.grib2
