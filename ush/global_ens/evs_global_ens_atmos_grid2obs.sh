#!/bin/ksh
#*********************************************************************************************************
# Script: evs_global_ens_atmos_grid2obs.sh
# Purpose: run Global ensembles (GEFS, CMCE, ECME, and NAEFS) grid2obs verification for surface fields
...
#
# Last update: 03/28/2025 by Gwen Chen (lichuan.chen@noaa.gov)
