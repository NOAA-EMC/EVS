...
for vhour in 00 12 ; do   #for 6h APCP  verification
#for vhour in  12 ; do      #for 24h APCP verification, only validate at 12Z
 ...
 for lead in $fhrs ; do
   ...
   for mbr in $mbrs ; do
       ...
       #ln -sf  ${EVSIN}.${fyyyymmdd}/gefs/gefs.ens${mbr}.t${ihour}z.grid3.24h.f${fhr}.nc  naefs.ens${mbr}.${fyyyymmdd}.t${ihour}z.grid3.24h.f${fhr}.nc
...
#     mbr40=$((mb+30))
#     if [ $vhour = 12 ] ; then
#       ln -sf  ${EVSIN}.${fyyyymmdd}/cmce/cmce.ens${mbr}.t${ihour}z.grid3.24h.f${fhr}.nc  naefs.ens${mbr40}.${fyyyymmdd}.t${ihour}z.grid3.24h.f${fhr}.nc
#
#     fi
#   done
