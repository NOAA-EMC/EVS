...
if wcount == 0:
    print(f"WARNING - Corrupted validation file in dcom: {input_file} has the wrong number of columns. global_ens-chem prep step will skip the corrupted validation file.")
wfile.close()
