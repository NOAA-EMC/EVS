  ...
  for vhour in ${validhours} ; do
    for wvar in ${wave_vars} ; do
      for stats in ${stats_list}; do
        ...
        echo "export DATA=${DATA} " >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
        echo "export MODNAM=${MODNAM} " >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
        echo "export PERIOD=${period} " >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
        echo "export VERIF_CASE=${VERIF_CASE} " >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
        ...
        case ${stats} in
          'stats1')
            ...
            ;;
          'stats2')
            echo "export METRIC=pcor " >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
            ;;
          'stats3')
            echo "export METRIC='fbar, obar' " >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
            ;;
          'stats4')
            echo "export METRIC=esd " >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
            ;; 
          'stats5')
            echo "export METRIC=si "  >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
            ;;
          'stats6')
            echo "export METRIC=p95 "  >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
            ;;
        esac
        echo "export FHR='000,024,048,072,096,120,144,168,192,216,240,264,288,312,336,360,384'" >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
        echo "export WVAR=${wvar}"      >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
        case ${wvar} in
          'WIND')
            echo "export OBS_LEVEL=Z10"  >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
            ;;
          *)
            echo "export OBS_LEVEL=L0"  >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
            ;;
        esac
        echo "export PTYPE=${ptype}" >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
        echo "${GRID2OBS_CONF}/py_plotting_wave.config"  >> plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
        
        chmod +x plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh
        
        echo "${DATA}/plot_${wvar}_${vhour}_${stats}_${ptype}_${period}.sh" >> plot_all_${MODELNAME}_${RUN}_g2o_plots.sh
