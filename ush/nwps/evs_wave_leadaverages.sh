...
for period in ${periods} ; do
  ...
  for vhr in ${inithours} ; do
	...
	echo "export VX_MASK_LIST=${MASK} " >> plot_${wfo}_${wvar}_${vhr}_${stats}_${ptype}_${period}.sh
        ...
        echo "export VERIF_CASE=${VERIF_CASE} " >> plot_${wfo}_${wvar}_${vhr}_${stats}_${ptype}_${period}.sh
        echo "export plot_start_date=${plot_start_date} " >> plot_${wfo}_${wvar}_${vhr}_${stats}_${ptype}_${period}.sh
	...
	echo "export WFO=${wfo} " >> plot_${wfo}_${wvar}_${vhr}_${stats}_${ptype}_${period}.sh
        case ${stats} in
          'stats1')
            ...
            ;;
          'stats2')
            echo "export METRIC=pcor " >> plot_${wfo}_${wvar}_${vhr}_${stats}_${ptype}_${period}.sh
            ;;
          'stats3')
            echo "export METRIC='fbar, obar' " >> plot_${wfo}_${wvar}_${vhr}_${stats}_${ptype}_${period}.sh
            ;;
          'stats4')
            echo "export METRIC=esd " >> plot_${wfo}_${wvar}_${vhr}_${stats}_${ptype}_${period}.sh
            ;; 
          'stats5')
            echo "export METRIC=si "  >> plot_${wfo}_${wvar}_${vhr}_${stats}_${ptype}_${period}.sh
            ;;
          'stats6')
        ...
        case ${wvar} in
          'WIND')
            echo "export OBS_LEVEL=Z10"  >> plot_${wfo}_${wvar}_${vhr}_${stats}_${ptype}_${period}.sh
            ;;
          *)
            echo "export OBS_LEVEL=L0"  >> plot_${wfo}_${wvar}_${vhr}_${stats}_${ptype}_${period}.sh
            ;;
        esac
        echo "export PTYPE=${ptype}" >> plot_${wfo}_${wvar}_${vhr}_${stats}_${ptype}_${period}.sh
        echo "${GRID2OBS_CONF}/py_plotting_wave.config"  >> plot_${wfo}_${wvar}_${vhr}_${stats}_${ptype}_${period}.sh
