          ...
          for obsname in $obsnames; do
              ...
              for region in $regions; do
                  ...
                  if [[ -s $output_image ]]; then
                      echo "cpreq -v $output_image $tmp_image" >> ${DATA}/jobs/plot_obs${OBTYPE}_${wvar}_v${valid_hour}z_f${fhr}_${stats}_${ptype}_${period}_${region}.sh
                  else
                      ...
                      if [ $SENDCOM = YES ]; then
                          echo "cpreq -v $tmp_image $output_image" >> ${DATA}/jobs/plot_obs${OBTYPE}_${wvar}_v${valid_hour}z_f${fhr}_${stats}_${ptype}_${period}_${region}.sh
                      fi
                  fi
