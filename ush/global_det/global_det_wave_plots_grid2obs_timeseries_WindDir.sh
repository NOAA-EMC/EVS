          ...
          for wvar in ${wave_vars} ; do
              ...
              for region in $regions; do
                  ...
                  case ${stats} in
                    'stats1')
                      image_stat="dir_me"
                      echo "export METRIC='dir_me' " >> ${DATA}/jobs/plot_obs${OBTYPE}_${wvar}_v${valid_hour}z_f${fhr}_${stats}_${ptype}_${period}_${region}.sh
                      ;;
                    'stats2')
                      image_stat="dir_mae"
                      echo "export METRIC=dir_mae " >> ${DATA}/jobs/plot_obs${OBTYPE}_${wvar}_v${valid_hour}z_f${fhr}_${stats}_${ptype}_${period}_${region}.sh
                      ;;
                    'stats3')
                      image_stat="dir_rmse"
                      echo "export METRIC='dir_rmse' " >> ${DATA}/jobs/plot_obs${OBTYPE}_${wvar}_v${valid_hour}z_f${fhr}_${stats}_${ptype}_${period}_${region}.sh
                      ;;
                  esac
