...
for verif_type in VERIF_CASE_STEP_type_list:
    ...
    for verif_type_job in list(verif_type_generate_jobs_dict.keys()):
        ...
        if verif_type == 'pres_levs':
            ...
            job_env_dict['mask_list'] = (
                "'"+FIXevs+"/masks/grid2obs_CONUS.nc, "
                +FIXevs+"/masks/grid2obs_WEST.nc, "
                +FIXevs+"/masks/grid2obs_EAST.nc, "
                +FIXevs+"/masks/grid2obs_NWC.nc, "
                +FIXevs+"/masks/grid2obs_SWC.nc, "
                +FIXevs+"/masks/grid2obs_NMT.nc, "
                +FIXevs+"/masks/grid2obs_SMT.nc, "
                +FIXevs+"/masks/grid2obs_GRB.nc, "
                +FIXevs+"/masks/grid2obs_SWD.nc, "
                +FIXevs+"/masks/grid2obs_NPL.nc, "
                +FIXevs+"/masks/grid2obs_SPL.nc, "
                +FIXevs+"/masks/grid2obs_MDW.nc, "
                +FIXevs+"/masks/grid2obs_LMV.nc, "
                +FIXevs+"/masks/grid2obs_GMC.nc, "
                +FIXevs+"/masks/grid2obs_NEC.nc, "
                +FIXevs+"/masks/grid2obs_SEC.nc, "
                +FIXevs+"/masks/grid2obs_APL.nc, "
                +FIXevs+"/masks/grid2obs_WCA.nc, "
                +FIXevs+"/masks/grid2obs_ECA.nc, "
                +FIXevs+"/masks/grid2obs_ATC.nc, "
                +FIXevs+"/masks/grid2obs_NAK.nc, "
                +FIXevs+"/masks/grid2obs_SAK.nc, "
                +FIXevs+"/masks/grid2obs_NPO.nc, "
                +FIXevs+"/masks/grid2obs_MEX.nc'"
            )
        # Loop through and write job script for dates and models
        date_dt = start_date_dt
        while date_dt <= end_date_dt:
