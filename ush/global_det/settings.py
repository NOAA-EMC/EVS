    ...
    def __init__(self):
        ...
        self.linetype_cols = {'FHO':['TOTAL','F_RATE','H_RATE','O_RATE'],
                              ...
                              'VL1L2':['TOTAL','UFBAR','VFBAR','UOBAR',
                                       ...
                                       'F_SPEED_BAR','O_SPEED_BAR', 'TOTAL_DIR',
                              ...
                              'VCNT':['TOTAL','FBAR','OBAR','FS_RMS','OS_RMS',
                                      ...
                                      'SPEED_ABSERR','DIR_ERR','DIR_ABSERR', 'ANOM_CORR',
                                      'ANOM_CORR_UNCNTR', 'TOTAL_DIR', 'DIR_ME', 'DIR_MAE',
                                      'DIR_MSE', 'DIR_RMSE'],
                ...
                'CTC': {
                    ...
                    'var_dict': {
                        'HTSGW_lo': {'fcst_var_names': ['HTSGW'],
                                     'fcst_var_levels': ['L0'],
                                     'fcst_var_thresholds': '<=3.0',
                                     'fcst_var_options': '',
                                     'obs_var_names': ['HTSGW'],
                                     'obs_var_levels': ['L0'],
                                     'obs_var_thresholds': '<=3.0',
                                     'obs_var_options': '',
                                     'plot_group':'sfc_wave'},
                        'HTSGW_hi': {'fcst_var_names': ['HTSGW'],
                                    'fcst_var_levels': ['L0'],
                                    'fcst_var_thresholds': '>=8.0',
                                    'fcst_var_options': '',
                                    'obs_var_names': ['HTSGW'],
                                    'obs_var_levels': ['L0'],
                                    'obs_var_thresholds': '>=8.0',
                                    'obs_var_options': '',
                                    'plot_group':'sfc_wave'},
                        'PERPW_lo': {'fcst_var_names': ['PERPW'],
                                    'fcst_var_levels': ['L0'],
                                    'fcst_var_thresholds': '<=8.0',
                                    'fcst_var_options': '',
                                    'obs_var_names': ['PERPW'],
                                    ...
                                    'obs_var_options': '',
                                    'plot_group':'sfc_wave'},
                        'PERPW_hi': {'fcst_var_names': ['PERPW'],
                                    'fcst_var_levels': ['L0'],
                                    'fcst_var_thresholds': '>12.0',
                                    'fcst_var_options': '',
                                    'obs_var_names': ['PERPW'],
                                    'obs_var_levels': ['L0'],
                                    'obs_var_thresholds': '>12.0',
                                    'obs_var_options': '',
                                    'plot_group':'sfc_wave'},                        
                        'WVHGT_lo': {'fcst_var_names': ['WVHGT'],
                                     'fcst_var_levels': ['L0'],
                                     'fcst_var_thresholds': '<=3.0',
                                     'fcst_var_options': '',
                                     'obs_var_names': ['WVHGT'],
                        ...
                        'WVPER_hi': {'fcst_var_names': ['WVPER'],
                                    ...
                                    'obs_var_options': '',
                                    'plot_group':'sfc_wave'},
                        'WIND_lo': {'fcst_var_names': ['WIND'],
                                    'fcst_var_levels': ['L0'],
                                    'fcst_var_thresholds': '<10.0, <20.0',
                                    'fcst_var_options': '',
                                    'obs_var_names': ['WIND'],
                                    'obs_var_levels': ['Z10'],
                                    'obs_var_thresholds': '<10.0, <20.0',
                                    'obs_var_options': '',
                                    'plot_group':'sfc_wave'},
                        'WIND_hi': {'fcst_var_names': ['WIND'],
                                    'fcst_var_levels': ['L0'],
                                    'fcst_var_thresholds': '>33.0, >49.4',
                                    'fcst_var_options': '',
                                    'obs_var_names': ['WIND'],
                                    'obs_var_levels': ['Z10'],
