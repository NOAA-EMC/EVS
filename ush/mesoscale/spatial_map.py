...
# Last Modified: May 18, 2023 by Marcel Caron             
...
#                {USHevs}/mesoscale_plots_precip_spatial_map.py, and runs the
#                spatial map. Lists of models and verification masking regions
#                can be provided; otherwise, single values must be provided to
#                inputs.
#
###############################################################################
...
# Load mesoscale and global_det modules
MODULES_DIR1 = "global_det"
MODULES_DIR2 = "mesoscale"
...
import mesoscale_plots_precip_spatial_map
...
for VX_MASK in VX_MASK_LIST:
    ...
    p = mesoscale_plots_precip_spatial_map.PrecipSpatialMap(
