...
#            'sample_equalization': True, # equalize samples along each value of the independent variable where data exist
            ...
            'clear_prune_directory': False, # just for SREF-GEFS non-precip comparison!
            ...
            'delete_intermed_data': False # whether or not to delete DataFrame rows if, for any model, rows include NaN (currently only used in lead_average.py)
        }
        ...
        self.case_type = {
            ...
            'precip_ccpa': {
                ...
                'CTC': {
                    ...
                    'interp': 'NEAREST',
                    'vx_mask_list' : [
                        'CONUS', 'CONUS_212', 'CONUS_East', 'CONUS_West', 'CONUS_Central', 
