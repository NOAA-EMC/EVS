#!/usr/bin/env python3
'''
Name: mesoscale_plots_precip_spatial_map.py
...
from mesoscale_plots_specs import PlotSpecs
...
class PrecipSpatialMap:
    ...
    def __init__(self, logger, input_dir, output_dir, restart_dir, model_info_dict,
...
def main():
    ...
    p = PrecipSpatialMap(logger, INPUT_DIR, OUTPUT_DIR, RESTART_DIR, MODEL_INFO_DICT,
