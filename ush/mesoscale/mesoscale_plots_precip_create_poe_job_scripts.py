...
# =============================================================================
#
# NAME: mesoscale_plots_precip_create_poe_job_scripts.sh
# CONTRIBUTOR(S): Marcel Caron, marcel.caron@noaa.gov, NOAA/NWS/NCEP/EMC-VPPPGB
#                 Roshan Shrestha, roshan.shrestha@noaa.gov, NOAA/NWS/NCEP/EMC-VPPPGB
# PURPOSE: Create EVS Mesoscale Precipitation - Plots POE job scripts
# DEPENDENCIES: $SCRIPTSevs/mesoscale/plots/exevs_$MODELNAME_precip_plots.sh
#
# =============================================================================
