...
class PlotSpecs:
    ...
    def get_model_plot_settings_test(self):
        """! Get dictionary plot settings for models
        ...
        """
        model_plot_settings_dict = {
            'model1': {'color': '#000000', 'markevery': 6,
                       'marker': 'o', 'markersize': 6,
                       'linestyle': 'solid', 'linewidth': 3},
            'model2': {'color': '#fb2020', 'markevery': 6,
                       'marker': '^', 'markersize': 7,
                       'linestyle': 'solid', 'linewidth': 1.5},
            'model3': {'color': '#1e3cff', 'markevery': 6,
                       'marker': 'X', 'markersize': 7,
                       'linestyle': 'solid', 'linewidth': 1.5},
            'model4': {'color': '#00dc00', 'markevery': 6,
                       'marker': 'P', 'markersize': 7,
                       'linestyle': 'solid', 'linewidth': 1.5},
            'model5': {'color': '#e69f00', 'markevery': 6,
                       'marker': 'o', 'markersize': 6,
                       'linestyle': 'solid', 'linewidth': 1.5},
            'model6': {'color': '#56b4e9', 'markevery': 6,
                       'marker': 'o', 'markersize': 6,
                       'linestyle': 'solid', 'linewidth': 1.5},
            'model7': {'color': '#696969', 'markevery': 6,
                       'marker': 's', 'markersize': 6,
                       'linestyle': 'solid', 'linewidth': 1.5},
            'model8': {'color': '#8400c8', 'markevery': 6,
                       'marker': 'D', 'markersize': 6,
                       'linestyle': 'solid', 'linewidth': 1.5},
            'model9': {'color': '#d269c1', 'markevery': 6,
                       'marker': 's', 'markersize': 6,
                       'linestyle': 'solid', 'linewidth': 1.5},
            'model10': {'color': '#f0e492', 'markevery': 6,
                        'marker': 'o', 'markersize': 6,
                        'linestyle': 'solid', 'linewidth': 1.5},
            'obs': {'color': '#aaaaaa', 'markevery': 6,
                    'marker': 'None', 'markersize': 0,
                    'linestyle': 'solid', 'linewidth': 2},
            'gfs': {'color': '#000000', 'markevery': 6,
                    'marker': 'o', 'markersize': 6,
                    'linestyle': 'solid', 'linewidth': 3},
            'gfs00Z': {'color': '#000000', 'markevery': 6,
                       'marker': 'o', 'markersize': 6,
                       'linestyle': 'solid', 'linewidth': 3},
            'gfs06Z': {'color': '#fb2020', 'markevery': 6,
                       'marker': '^', 'markersize': 7,
                       'linestyle': 'solid', 'linewidth': 1.5},
            'gfs12Z': {'color': '#1e3cff', 'markevery': 6,
                       'marker': 'X', 'markersize': 7,
                       'linestyle': 'solid', 'linewidth': 1.5},
            'gfs18Z': {'color': '#e69f00', 'markevery': 6,
                       'marker': 'o', 'markersize': 7,
                       'linestyle': 'solid', 'linewidth': 1.5},
            'cfs': {'color': '#56b4e9', 'markevery': 6,
                    'marker': 'o', 'markersize': 6,
                    'linestyle': 'solid', 'linewidth': 1.5},
            'cmc': {'color': '#1e3cff', 'markevery': 6,
                     'marker': 'X', 'markersize': 7,
                     'linestyle': 'solid', 'linewidth': 1.5},
            'cmc_regional': {'color': '#8400c8', 'markevery': 6,
                             'marker': 'D', 'markersize': 6,
                             'linestyle': 'solid', 'linewidth': 1.5},
            'dwd': {'color': '#56b4e9', 'markevery': 6,
                    'marker': 'o', 'markersize': 6,
                    'linestyle': 'solid', 'linewidth': 1.5},
            'ecmwf': {'color': '#fb2020', 'markevery': 6,
                      'marker': '^', 'markersize': 7,
                      'linestyle': 'solid', 'linewidth': 1.5},
            'fnmoc': {'color': '#00dc00', 'markevery': 6,
                      'marker': 'P', 'markersize': 7,
                      'linestyle': 'solid', 'linewidth': 1.5},
            'imd': {'color': '#8400c8', 'markevery': 6,
                    'marker': 'D', 'markersize': 6,
                    'linestyle': 'solid', 'linewidth': 1.5},
            'jma': {'color': '#696969', 'markevery': 6,
                    'marker': 's', 'markersize': 6,
                    'linestyle': 'solid', 'linewidth': 1.5},
            'metfra': {'color': '#00dc00', 'markevery': 6,
                      'marker': 'P', 'markersize': 7,
                      'linestyle': 'solid', 'linewidth': 1.5},
            'ukmet': {'color': '#e69f00', 'markevery': 6,
                      'marker': 'o', 'markersize': 7,
                      'linestyle': 'solid', 'linewidth': 1.5},
        }
        return model_plot_settings_dict
