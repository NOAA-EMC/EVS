...
for headline_type in input_obs_types:
    ...
    if headline_type == "ozmax8":
        icnt += 1
        ### Headline Score Plot : Grid-to-OBS - Daily MAX 8-HR AVG OZONE concentration CONUS
        ###                                      Last 90 days 12Z CYCLE DAY2 FCST 
        print("\nHeadline Score Plot "+str(icnt)+" : Grid-to-OBS - Daily MAX 8-HR AVG OZONE concentration CONUS "
              +"Last 90 days 12Z CYCLE DAY2 FCST")
    ...
    elif headline_type == "pmave":
        icnt += 1
        ### Headline Score Plot : Grid-to-OBS - Daily 24-HR AVG PM2.5 concentration CONUS
        ###                                      Last 90 days 12Z CYCLE DAY2 FCST 
        print("\nHeadline Score Plot "+str(icnt)+" : Grid-to-OBS - Daily 24-HR AVG PM2.5 concentration CONUS "
              +"Last 90 days 12Z CYCLE DAY2 FCST")
        # Set fixed plot values
        headline1_plot = 'time_series'
        headline1_ndays = 90
