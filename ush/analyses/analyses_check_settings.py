...
evs_analyses_settings_dict = {}
evs_analyses_settings_dict['evs'] = [
...
evs_analyses_settings_dict['shared'] = []
evs_analyses_settings_dict['modules'] = ['METPLUS_PATH', 'MET_ROOT']
evs_analyses_settings_dict['RUN_PRECIP_PREP'] = [
...
for env_group in env_group_list:
    env_var_list = evs_analyses_settings_dict[env_group]
