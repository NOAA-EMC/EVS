...
Abstract: This script generates a performance diagram plot.
'''
...
class PerformanceDiagram:
    ...
    def __init__(self, logger, input_dir, output_dir, model_info_dict,
        ...
        """! Initialize PerformanceDiagram class
    ...
    def make_performance_diagram(self):
        """! Create the performance diagram graphic

             Args:

             Returns:
        """
        self.logger.info(f"Creating performance diagrams...")
        ...
        for fcst_var_thresh in self.plot_info_dict['fcst_var_threshs']:
            ...
            for stat in perf_dia_stat_list:
                self.logger.info(f"Calculating statistic {stat} from line type "
                ...
                for model_idx in model_idx_list:
                    ...
                    model_idx_fcst_var_thresh_avg = sub_util.calculate_average(
