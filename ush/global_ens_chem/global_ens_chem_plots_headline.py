...
for stat in ['ME', 'RMSE']:
    ...
    import global_ens_chem_plots_time_series_multifhr as gdap_tsmf
...
if evs_run_mode == 'production' and envir != 'dev':
    ...
    import global_ens_chem_plots_long_term_time_series as gdap_ltts
    ...
    import global_ens_chem_plots_long_term_useful_forecast_days as gdap_ltufd
    ...
    import global_ens_chem_plots_long_term_time_series_multifhr \
        as gdap_lttsmf
