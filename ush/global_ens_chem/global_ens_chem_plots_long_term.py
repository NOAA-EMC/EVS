#!/usr/bin/env python3
'''
Name: global_ens_chem_plots_long_term.py
Contact(s): Mallory Row (mallory.row@noaa.gov)
Abstract: This is the driver script for creating long-term plots.
Run By: scripts/plots/global_det/exevs_global_ens_chem_long_term_plots.sh
'''
        ...
        for var_name in list(plot_info_dict.keys()):
            ...
            for plot_loop in list(
                ...
                logger.info(f"Working on {var_name} {var_level} {vx_mask} "
                            +f"{stat}")
                if avg_time_range == 'monthly':
                    import global_ens_chem_plots_long_term_time_series_diff \
                        as gdap_lttsd
                    ...
                    import global_ens_chem_plots_long_term_lead_by_date \
                        as gdap_ltlbd
                    ...
                    if stat == 'ACC' and var_name == 'HGT' \
                        ...
                        import global_ens_chem_plots_long_term_useful_forecast_days \
                            as gdap_ltufd
                    ...
                    import global_ens_chem_plots_long_term_annual_mean \
                        as gdap_ltam
