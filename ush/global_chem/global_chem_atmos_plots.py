#!/usr/bin/env python3
'''
Name: global_chem_atmnos_plots.py
...
Run By: individual plotting job scripts generated through
        ush/global_chem/global_chem_atmnos_plots_grid2obs_create_job_scripts.py
'''
...
if JOB_GROUP == 'condense_stats':
    ...
    met_info_dict = original_met_info_dict.copy()
    if plot == 'time_series':
        import global_chem_atmnos_plots_time_series as gdap_ts
        for ts_info in \
        ...
        import global_chem_atmnos_plots_lead_average as gdap_la
        ...
        import global_chem_atmnos_plots_valid_hour_average as gdap_vha
        ...
        import global_chem_atmnos_plots_threshold_average as gdap_ta
        ...
        import global_chem_atmnos_plots_performance_diagram as gdap_pd
