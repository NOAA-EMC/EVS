#!/usr/bin/env python3
'''
Name: global_chem_atmnos_check_settings.py
...
Run By: scripts/plots/global_chem/exevs_global_chem_atmnos_grid2obs_plots.sh
'''
...
evs_global_chem_atmnos_settings_dict = {}
if evs_run_mode == 'production':
    evs_global_chem_atmnos_settings_dict['evs'] = [
...
evs_global_chem_atmnos_settings_dict['shared'] = [
...
evs_global_chem_atmnos_settings_dict['modules'] = ['MET_ROOT', 'METPLUS_PATH']
evs_global_chem_atmnos_settings_dict['RUN_GRID2GRID_PLOTS'] = [
    'g2gp_model_plot_name_list', 'g2gp_type_list',
    'g2gp_event_equalization'
]
evs_global_chem_atmnos_settings_dict['RUN_GRID2OBS_PLOTS'] = [
...
for env_check_group in env_check_group_list:
    env_var_check_list = (
        evs_global_chem_atmnos_settings_dict[env_check_group]
    )
        ...
        if not env_var_check in os.environ:
            if env_check_group == 'modules':
                print("FATAL ERROR: "+env_var_check+" not set in environment, "
                      ...
                      +"global_chem_atmnos_load_modules.sh")
