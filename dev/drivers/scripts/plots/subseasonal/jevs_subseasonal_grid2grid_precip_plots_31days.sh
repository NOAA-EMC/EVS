#PBS -N jevs_subseasonal_grid2grid_precip_plots_31days
#PBS -j oe
#PBS -S /bin/bash
#PBS -q "dev"
#PBS -A VERF-DEV
#PBS -l walltime=00:15:00
#PBS -l place=vscatter:exclhost,select=4:ncpus=128:mem=500GB
#PBS -l debug=true
...
export job=${PBS_JOBNAME:-jevs_subseasonal_grid2grid_precip_plots_31days}
