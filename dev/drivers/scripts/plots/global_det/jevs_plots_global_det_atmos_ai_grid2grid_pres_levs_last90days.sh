#PBS -N jevs_plots_global_det_atmos_ai_grid2grid_pres_levs_last90days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export KEEPDATA=NO
export SENDDBN=NO
export job=${PBS_JOBNAME:-jevs_plots_global_det_atmos_ai_grid2grid_pres_levs_last90days}
...
export RUN=atmos
export VERIF_CASE=ai_grid2grid
...
#          atmospheric grid-to-grid pres_levs for last 90 days
######################################################################
