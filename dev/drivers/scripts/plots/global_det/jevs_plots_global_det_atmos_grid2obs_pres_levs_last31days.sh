#PBS -N jevs_plots_global_det_atmos_grid2obs_pres_levs_last31days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export KEEPDATA=NO
export SENDDBN=NO
export job=${PBS_JOBNAME:-jevs_plots_global_det_atmos_grid2obs_pres_levs_plots_last31days}
