#PBS -N jevs_global_det_atmos_grid2obs_ptype_plots_last90days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export KEEPDATA=YES
export SENDDBN=NO
export job=${PBS_JOBNAME:-jevs_global_det_atmos_grid2obs_ptype_plots_last90days}
...
#          atmospheric grid-to-observations ptype for last 90 days
######################################################################
