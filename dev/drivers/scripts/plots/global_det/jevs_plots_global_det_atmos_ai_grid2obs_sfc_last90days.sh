#PBS -N jevs_plots_global_det_atmos_ai_grid2obs_sfc_last90days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export KEEPDATA=NO
export SENDDBN=NO
export job=${PBS_JOBNAME:-jevs_plots_global_det_atmos_ai_grid2obs_sfc_last90days}
...
#          atmospheric grid-to-observations sfc for last 90 days
######################################################################
