#PBS -N jevs_plots_global_chem_atmos_grid2obs_hourly_last31days
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export KEEPDATA=NO
export SENDDBN=NO
export job=${PBS_JOBNAME:-jevs_plots_global_chem_atmos_grid2obs_hourly_last31days}
...
#          grid-to-observations hourly for last 31 days
######################################################################
