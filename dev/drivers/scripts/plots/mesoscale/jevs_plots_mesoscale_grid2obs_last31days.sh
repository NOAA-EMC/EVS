#PBS -N jevs_plots_mesoscale_grid2obs_last31days
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=01:25:00
#PBS -l place=vscatter:exclhost,select=6:ncpus=128:mem=100GB
#PBS -l debug=true
...
export SENDDBN_NTC=
export SENDMAIL=YES
export job=${PBS_JOBNAME:-jevs_plots_mesoscale_grid2obs_last31days}
