#PBS -N jevs_global_det_wave_g2o_prep
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
############################################################
$HOMEevs/jobs/global_det/prep/JEVS_GLOBAL_DET_WAVE_GRID2OBS_PREP

##%include <tail.h>
##%manual
#####################################################################
# Purpose: This does the prep work for the global_det GFS-Wave model
#####################################################################
##%end
exit
