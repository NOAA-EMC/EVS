#PBS -N jevs_fnmoc_atmos_grid2grid_stats_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=00:15:00
#PBS -l place=vscatter,select=1:ncpus=20:ompthreads=1:mem=5GB
#PBS -l debug=true
#PBS -V
...
export job=${PBS_JOBNAME:-jevs_fnmoc_atmos_grid2grid_stats}
