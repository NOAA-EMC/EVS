#PBS -N jevs_global_det_atmos_ecmwf_grid2grid_stats_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=00:20:00
#PBS -l place=vscatter,select=1:ncpus=53:ompthreads=1:mem=50GB
#PBS -l debug=true
#PBS -V
...
export job=${PBS_JOBNAME:-jevs_global_det_atmos_ecmwf_grid2grid_stats}
