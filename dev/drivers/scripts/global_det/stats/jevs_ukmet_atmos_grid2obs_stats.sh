#PBS -N jevs_ukmet_atmos_grid2obs_stats_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=00:15:00
#PBS -l place=vscatter,select=1:ncpus=14:ompthreads=1:mem=5GB
#PBS -l debug=true
#PBS -V
...
export job=${PBS_JOBNAME:-jevs_ukmet_atmos_grid2obs_stats}
