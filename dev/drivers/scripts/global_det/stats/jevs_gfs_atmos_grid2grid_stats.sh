#PBS -N jevs_gfs_atmos_grid2grid_stats_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=01:00:00
#PBS -l place=vscatter,select=1:ncpus=128:ompthreads=1:mem=225GB
#PBS -l debug=true
#PBS -V
...
export job=${PBS_JOBNAME:-jevs_gfs_atmos_grid2grid_stats}
