#PBS -N jevs_global_det_wave_g2o_stats
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export job=${PBS_JOBNAME:-jevs_global_det_wave_g2o_stats}
...
############################################################
$HOMEevs/jobs/global_det/stats/JEVS_GLOBAL_DET_WAVE_GRID2OBS_STATS

##%include <tail.h>
##%manual
#######################################################################
# Purpose: This calculates the stats for the global_det GFS-Wave model
#######################################################################
##%end
exit
