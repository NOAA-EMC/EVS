#PBS -N jevs_global_det_atmos_grid2grid_sea_ice_plots_90days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=00:10:00
#PBS -l place=vscatter,select=1:ncpus=22:ompthreads=1:mem=20GB
#PBS -l debug=true
#PBS -V
...
export job=${PBS_JOBNAME:-jevs_global_det_atmos_grid2grid_sea_ice_plots_90days}
...
#          atmospheric grid-to-grid sea_ice for past 90 days
######################################################################
