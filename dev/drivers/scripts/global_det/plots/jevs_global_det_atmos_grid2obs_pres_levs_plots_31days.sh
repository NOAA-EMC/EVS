#PBS -N jevs_global_det_atmos_grid2obs_pres_levs_plots_31days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=00:45:00
#PBS -l place=vscatter:exclhost,select=5:ncpus=128:ompthreads=1:mem=100GB
#PBS -l debug=true
#PBS -V
...
export SENDCOM=YES
export KEEPDATA=NO
export job=${PBS_JOBNAME:-jevs_global_det_atmos_grid2obs_pres_levs_plots_31days}
...
#          atmospheric grid-to-observations pres_levs for past 31 days
######################################################################
