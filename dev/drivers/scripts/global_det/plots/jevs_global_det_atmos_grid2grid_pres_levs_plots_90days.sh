#PBS -N jevs_global_det_atmos_grid2grid_pres_levs_plots_90days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=00:30:00
#PBS -l place=vscatter:exclhost,select=1:ncpus=128:ompthreads=1:mem=75GB
#PBS -l debug=true
#PBS -V
...
export SENDCOM=YES
export KEEPDATA=NO
export job=${PBS_JOBNAME:-jevs_global_det_atmos_grid2grid_pres_levs_plots_90days}
...
#          atmospheric grid-to-grid pres_levs for past 90 days
######################################################################
