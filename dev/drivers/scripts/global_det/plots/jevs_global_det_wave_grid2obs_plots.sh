#PBS -N jevs_global_det_wave_g2o_plots
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export job=${PBS_JOBNAME:-jevs_global_det_wave_g2o_prep}
...
############################################################
${HOMEevs}/jobs/global_det/plots/JEVS_GLOBAL_DET_WAVE_GRID2OBS_PLOTS

#%include <tail.h>
#%manual
#########################################################################
# Purpose: This job creates the plots for the global_det GFS-Wave model
#########################################################################
#%end
