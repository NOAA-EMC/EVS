#PBS -N jevs_global_det_atmos_grid2grid_precip_plots_31days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDCOM=YES
export KEEPDATA=NO
export job=${PBS_JOBNAME:-jevs_global_det_atmos_grid2grid_precip_plots_31days}
...
#          atmospheric grid-to-grid precip for past 31 days
######################################################################
