#PBS -N jevs_global_det_atmos_grid2grid_snow_plots_90days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDCOM=YES
export KEEPDATA=NO
export job=${PBS_JOBNAME:-jevs_global_det_atmos_grid2grid_snow_plots_90days}
...
#          atmospheric grid-to-grid snow for past 90 days
######################################################################
