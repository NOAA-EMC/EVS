#PBS -N jevs_global_det_atmos_grid2grid_precip_plots_90days_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=00:30:00
#PBS -l place=vscatter:exclhost,select=1:ncpus=128:ompthreads=1:mem=100GB
#PBS -l debug=true
#PBS -V
...
#          atmospheric grid-to-grid precip for past 90 days
######################################################################
