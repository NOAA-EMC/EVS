#PBS -S /bin/bash
#PBS -N jevs_cam_hireswfv3_grid2obs_prep
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev_transfer
#PBS -A EVS-DEV
...
export SENDDBN=YES
export SENDDBN_NTC=
export job=${PBS_JOBNAME:-jevs_cam_hireswfv3_grid2obs_prep}
...
# Developer Settings
export DATAROOTROOTROOT=/lfs/h2/emc/stmp/$USER/evs_test/$envir/tmp/${jobid:?}
