...
#PBS -N jevs_cam_href_spcoutlook_stat
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
#export COMINspcoutlook=/lfs/h2/emc/vpppg/noscrub/${USER}/evs/v1.0/prep/cam/href
export COMINspcotlk=/lfs/h2/emc/vpppg/noscrub/logan.dawson/evs/v1.0/prep/cam/spc_otlk
