#PBS -N jevs_stats_cam_rrfsmem_grid2obs
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=01:15:00
#PBS -l place=vscatter:exclhost,select=1:ncpus=128:ompthreads=1:mem=110GB
#PBS -l debug=true
...
export SENDDBN=NO
export SENDDBN_NTC=
export job=${PBS_JOBNAME:-jevs_stats_cam_rrfsmem_grid2obs}
