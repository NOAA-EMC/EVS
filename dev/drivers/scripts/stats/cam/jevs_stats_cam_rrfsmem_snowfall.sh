#PBS -N jevs_stats_cam_rrfsmem_snowfall
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=00:30:00
#PBS -l place=exclhost,select=1:ncpus=128:ompthreads=1:mem=140GB
#PBS -l debug=true
...
export KEEPDATA=NO
export SENDDBN=NO
export job=${PBS_JOBNAME:-jevs_stats_cam_rrfsmem_snowfall}
