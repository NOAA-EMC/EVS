#PBS -N jevs_stats_global_det_atmos_long_term_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
...
export SENDCOM=YES
export KEEPDATA=NO
export job=${PBS_JOBNAME:-jevs_stats_global_det_atmos_long_term}
...
$HOMEevs/jobs/JEVS_STATS_GLOBAL_DET_ATMOS_LONG_TERM
