...
for ftype in prog diag ice; do
  ...
  $COMOUTprep/rtofs.$VDATE/$RUN/rtofs_glo_2ds_f000_${ftype}.$RUN.nc
done
...
if [ $RUN = 'argo' ] ; then
  for ftype in t s; do
    ...
    $COMOUTprep/rtofs.$VDATE/$RUN/rtofs_glo_3dz_f000_daily_3z${ftype}io.$RUN.nc
  done
fi
...
for ftype in prog diag ice; do
  ...
  $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f024_${ftype}.$RUN.nc
done
...
if [ $RUN = 'argo' ] ; then
  for ftype in t s; do
    ...
    $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_3dz_f024_daily_3z${ftype}io.$RUN.nc
  done
fi
...
for ftype in prog diag ice; do
  ...
  $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f048_${ftype}.$RUN.nc
done
...
if [ $RUN = 'argo' ] ; then
  for ftype in t s; do
    ...
    $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_3dz_f048_daily_3z${ftype}io.$RUN.nc
  done
fi
...
for ftype in prog diag ice; do
  ...
  $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f072_${ftype}.$RUN.nc
done
...
if [ $RUN = 'argo' ] ; then
  for ftype in t s; do
    ...
    $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_3dz_f072_daily_3z${ftype}io.$RUN.nc
  done
fi
...
for ftype in prog diag ice; do
  ...
  $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f096_${ftype}.$RUN.nc
done
...
if [ $RUN = 'argo' ] ; then
  for ftype in t s; do
    ...
    $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_3dz_f096_daily_3z${ftype}io.$RUN.nc
  done
fi
...
for ftype in prog diag ice; do
  ...
  $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f120_${ftype}.$RUN.nc
done
...
if [ $RUN = 'argo' ] ; then
  for ftype in t s; do
    ...
    $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_3dz_f120_daily_3z${ftype}io.$RUN.nc
  done
fi
...
for ftype in prog diag ice; do
  ...
  $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f144_${ftype}.$RUN.nc
done
...
if [ $RUN = 'argo' ] ; then
  for ftype in t s; do
    ...
    $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_3dz_f144_daily_3z${ftype}io.$RUN.nc
  done
fi
...
for ftype in prog diag ice; do
  ...
  $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f168_${ftype}.$RUN.nc
done
...
if [ $RUN = 'argo' ] ; then
  for ftype in t s; do
    ...
    $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_3dz_f168_daily_3z${ftype}io.$RUN.nc
  done
fi
...
for ftype in prog diag ice; do
  ...
  $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f192_${ftype}.$RUN.nc
done
...
if [ $RUN = 'argo' ] ; then
  for ftype in t s; do
    ...
    $COMOUTprep/rtofs.$INITDATE/$RUN/rtofs_glo_3dz_f192_daily_3z${ftype}io.$RUN.nc
  done
fi
