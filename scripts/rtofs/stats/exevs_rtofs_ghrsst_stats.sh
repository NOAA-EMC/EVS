...
#    with GHRSST data using MET/METplus.
...
if [ ! -s $COMINobs/GHRSST/GHRSST-OSPO-L4-GLOB_$VDATE.nc ] ; then
   echo "Missing validation GHRSST data file for $VDATE" 
   exit
fi
...
-c $CONFIGevs/grid2grid/$STEP/GridStat_fcstRTOFS_obsGHRSST_climoWOA18.conf
