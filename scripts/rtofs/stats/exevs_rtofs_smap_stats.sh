...
if [ ! -s $COMINobs/SMAP/SMAP-L3-GLOB_$VDATE.nc ] ; then
   echo "Missing validation SMAP data file for $VDATE" 
   exit
fi
...
-c $CONFIGevs/grid2grid/$STEP/GridStat_fcstRTOFS_obsSMAP_climoWOA18.conf
