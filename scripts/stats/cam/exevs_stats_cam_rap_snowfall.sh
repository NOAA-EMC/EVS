...
# Get RAP and NOHRSC data
python $USHevs/${COMPONENT}/${COMPONENT}_snowfall_stats_get_data.py
...
for group in $JOB_GROUP_list; do
    ...
    python $USHevs/${COMPONENT}/${COMPONENT}_snowfall_stats_create_job_scripts.py
