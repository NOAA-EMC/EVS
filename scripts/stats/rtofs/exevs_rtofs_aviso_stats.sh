...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$VDATE/$RUN/rtofs_glo_2ds_f000_diag.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f024_diag.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f048_diag.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f072_diag.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f096_diag.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f120_diag.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f144_diag.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f168_diag.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f192_diag.$RUN.nc ] ; then
