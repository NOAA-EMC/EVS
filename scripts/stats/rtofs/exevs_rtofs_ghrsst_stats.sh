...
min_size=2404
actual_size=$(wc -c <"$DCOMROOT/$VDATE/validation_data/marine/ghrsst/${VDATE}_OSPO_L4_GHRSST.nc")
if [ -s $DCOMROOT/$VDATE/validation_data/marine/ghrsst/${VDATE}_OSPO_L4_GHRSST.nc ] && [ $actual_size -ge $min_size ]; then
   ...
   echo "WARNING: Missing GHRSST data file for $VDATE: $DCOMROOT/$VDATE/validation_data/marine/ghrsst/${VDATE}_OSPO_L4_GHRSST.nc"
