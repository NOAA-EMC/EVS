...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$VDATE/$RUN/ice_conc_nh_polstere-100_multi_${VDATE}1200.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f024_ice.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f048_ice.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f072_ice.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f096_ice.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f120_ice.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f144_ice.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f168_ice.$RUN.nc ] ; then
...
if [ ! -s $COMIN/prep/$COMPONENT/rtofs.$INITDATE/$RUN/rtofs_glo_2ds_f192_ice.$RUN.nc ] ; then
...
-c $CONFIGevs/$STEP/$COMPONENT/${VERIF_CASE}/GridStat_fcstRTOFS_obsOSISAF_nh.conf

run_metplus.py -c ${PARMevs}/metplus_config/machine.conf \
-c $CONFIGevs/$STEP/$COMPONENT/${VERIF_CASE}/GridStat_fcstRTOFS_obsOSISAF_sh.conf
