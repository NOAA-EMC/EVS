#!/bin/bash
set -x
export PS4=' + exevs_hurricane_regional_late_tropcyc_all_stats.sh line $LINENO: '
...
export basinlist="ep"
export numlist="01 02 03 04 05 06 07 08 09 10 11 12 13 14 15 16 17 19 20 \ # HAFS became operational on June 27, 2023.
