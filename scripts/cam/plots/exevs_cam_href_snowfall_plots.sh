...
if [ $run_mpi = yes ] ; then
  export LD_LIBRARY_PATH=/apps/dev/pmi-fix:$LD_LIBRARY_PATH
   mpiexec -np 30 -ppn 30 --cpu-bind verbose,depth cfp run_all_poe.sh
else
 sh run_all_poe.sh
fi
...
#scp *.png wd20bz@emcrzdm:/home/people/emc/www/htdocs/bzhou/evs_plots/href/snowfall

tar -cvf plots.href.snowfall.v${VDATE}.past${past_days}days.tar *.png

cp plots.href.snowfall.v${VDATE}.past${past_days}days.tar  $COMOUT/.  
