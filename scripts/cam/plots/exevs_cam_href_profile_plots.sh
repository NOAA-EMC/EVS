...
#scp *.png wd20bz@emcrzdm:/home/people/emc/www/htdocs/bzhou/evs_plots/href/profile

tar -cvf plots.href.profile.v${VDATE}.past${past_days}days.tar *.png

cp plots.href.profile.v${VDATE}.past${past_days}days.tar  $COMOUT/.  
