#!/bin/bash
set -x
export PS4=' + exevs_hurricane_regional_early_tropcyc_all_plots.sh line $LINENO: '
...
export fhr_list="0,12,24,36,48,60,72,96,120"
export model_tmp_atcf_name_list="MD01,MD02,MD03,MD04,MD05,MD06,MD07"
export model_plot_name_list="AVNI,HWFI,HMNI,CTCI,HFAI,HFBI,OFCL"
...
export tropcyc_model_type="regional_all"
...
if [ $nimgs -ne 0 ]; then
  ...
  if [ "$SENDCOM" = 'YES' ]; then
    cp ${STORMroot}/plot/${tc_name}/images/ABSAMAX_WIND-BMAX_WIND_fhrmean_${tc_name}_${tropcyc_model_type}.gif ${comoutroot}/evs.hurricane_regional_early.abswind_err.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
    cp ${STORMroot}/plot/${tc_name}/images/AMAX_WIND-BMAX_WIND_fhrmean_${tc_name}_${tropcyc_model_type}.gif ${comoutroot}/evs.hurricane_regional_early.wind_bias.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png 
    cp ${STORMroot}/plot/${tc_name}/images/ABSTK_ERR_fhrmean_${tc_name}_${tropcyc_model_type}.gif ${comoutroot}/evs.hurricane_regional_early.abstk_err.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
    cp ${STORMroot}/plot/${tc_name}/images/ALTK_ERR_fhrmean_${tc_name}_${tropcyc_model_type}.gif ${comoutroot}/evs.hurricane_regional_early.altk_bias.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
    cp ${STORMroot}/plot/${tc_name}/images/CRTK_ERR_fhrmean_${tc_name}_${tropcyc_model_type}.gif ${comoutroot}/evs.hurricane_regional_early.crtk_bias.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
  fi
fi
...
if [ $bimgs -ne 0 ]; then
  ...
  if [ "$SENDCOM" = 'YES' ]; then
    cp -r ${metTCcomout}/plot/${tc_name}/images/ABSAMAX_WIND-BMAX_WIND_fhrmean_${tc_name}_${tropcyc_model_type}.gif ${comoutbas}/evs.hurricane_regional_early.abswind_err.${stormBasin}.${stormYear}.season.png
    cp -r ${metTCcomout}/plot/${tc_name}/images/AMAX_WIND-BMAX_WIND_fhrmean_${tc_name}_${tropcyc_model_type}.gif ${comoutbas}/evs.hurricane_regional_early.wind_bias.${stormBasin}.${stormYear}.season.png
    cp -r ${metTCcomout}/plot/${tc_name}/images/ABSTK_ERR_fhrmean_${tc_name}_${tropcyc_model_type}.gif ${comoutbas}/evs.hurricane_regional_early.abstk_err.${stormBasin}.${stormYear}.season.png
    cp -r ${metTCcomout}/plot/${tc_name}/images/ALTK_ERR_fhrmean_${tc_name}_${tropcyc_model_type}.gif ${comoutbas}/evs.hurricane_regional_early.altk_bias.${stormBasin}.${stormYear}.season.png
    cp -r ${metTCcomout}/plot/${tc_name}/images/CRTK_ERR_fhrmean_${tc_name}_${tropcyc_model_type}.gif ${comoutbas}/evs.hurricane_regional_early.crtk_bias.${stormBasin}.${stormYear}.season.png
  fi
fi
