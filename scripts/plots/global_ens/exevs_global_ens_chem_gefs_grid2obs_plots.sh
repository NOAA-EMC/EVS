...
python ${USHevs}/${COMPONENT}_${RUN}/${COMPONENT}_${RUN}_${MODELNAME}_check_settings.py
export err=$?; err_chk

# Create output directories
python ${USHevs}/${COMPONENT}_${RUN}/${COMPONENT}_${RUN}_${MODELNAME}_create_output_dirs.py
export err=$?; err_chk

# Link needed data files and set up model information
python ${USHevs}/${COMPONENT}_${RUN}/${COMPONENT}_${RUN}_${MODELNAME}_get_data_files.py
export err=$?; err_chk
...
for group in condense_stats filter_stats make_plots tar_images; do
    ...
    python ${USHevs}/${COMPONENT}_${RUN}/${COMPONENT}_${RUN}_${MODELNAME}_${STEP}_${VERIF_CASE}}_create_job_scripts.py
    export err=$?; err_chk
