#!/bin/ksh
#*******************************************************************************
# Purpose: set up environment, paths, and run the aigefs grid2grid 
            ...
            for level in $levels ; do
                ...
                if [ $var = prmsl ] ; then
                    if [ -f "lead_average_regional_${domain}_valid_${ihr}_${var}_${stats}.png" ]; then
                        mv lead_average_regional_${domain}_valid_${ihr}_${var}_${stats}.png evs.${COMPONENT}.${evs_graphic_stats}.${var}_${plevel}.last${past_days}days.fhrmean_valid${ihr}_f384.g003_${domain_new}.png
                    fi
                else
                    if [ -f "lead_average_regional_${domain}_valid_${ihr}_${level}${unit}_${var}_${stats}.png" ]; then
                        mv lead_average_regional_${domain}_valid_${ihr}_${level}${unit}_${var}_${stats}.png evs.${COMPONENT}.${evs_graphic_stats}.${var}_${plevel}.last${past_days}days.fhrmean_valid${ihr}_f384.g003_${domain_new}.png
                    fi
                fi
                ...
                for lead in 24 120 240 360; do
                    if [ $var = prmsl ] ; then
                        if [ -f "time_series_regional_${domain}_valid_${ihr}_${var}_${stats}_f${lead}.png" ]; then
                            mv time_series_regional_${domain}_valid_${ihr}_${var}_${stats}_f${lead}.png evs.${COMPONENT}.${evs_graphic_stats}.${var}_${plevel}.last${past_days}days.timeseries_valid${ihr}_f${lead}.g003_${domain_new}.png
                        fi
                    else
                        if [ -f "time_series_regional_${domain}_valid_${ihr}_${level}${unit}_${var}_${stats}_f${lead}.png" ]; then
                            mv time_series_regional_${domain}_valid_${ihr}_${level}${unit}_${var}_${stats}_f${lead}.png evs.${COMPONENT}.${evs_graphic_stats}.${var}_${plevel}.last${past_days}days.timeseries_valid${ihr}_f${lead}.g003_${domain_new}.png
                        fi
                    fi
                done # lead
            done # level
