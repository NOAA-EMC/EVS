    ...
    for VERIF_TYPE_SUBDIR_PATH in $DATA/${VERIF_CASE}_${STEP}/plot_output/$RUN.${end_date}/images/*; do
        ...
        for TAR_FILE in *.tar; do
            if [ $nTAR_FILE = 1 ]; then
                ...
                tar -Avf ${DATA}/${VERIF_CASE}_${STEP}/plot_output/${RUN}.${end_date}/images/evs.plots.${COMPONENT}.${RUN}.grid2grid_${VERIF_TYPE_SUBDIR}.last${NDAYS}days.v${PDYm1}.tar $TAR_FILE
            fi
