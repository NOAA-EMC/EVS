...
if [ $SENDCOM = YES ]; then
    ...
    tar -cvf ${DATA}/${VERIF_CASE}_${STEP}/plot_output/${RUN}.${PDYm1}/plots_${COMPONENT}_${RUN}_grid2obs_${NDAYS}days_v${PDYm1}.tar *
    cd $DATA
    cp -v ${DATA}/${VERIF_CASE}_${STEP}/plot_output/${RUN}.${PDYm1}/plots_${COMPONENT}_${RUN}_grid2obs_${NDAYS}days_v${PDYm1}.tar $COMOUT/.
fi
