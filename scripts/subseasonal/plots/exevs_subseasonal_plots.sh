#!/bin/sh
# Program Name: evs_subseasonal_plots
# Author(s)/Contact(s): Shannon Shields
# Abstract: Run METplus for subseasonal grid-to-grid and grid-to-obs verification
#           to produce plots
# History Log:
...
python $USHevs/subseasonal/check_subseasonal_config.py
status=$?
