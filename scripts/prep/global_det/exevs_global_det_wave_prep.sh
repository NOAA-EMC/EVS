    ...
    if [ $MODEL == "gfs" ]; then
        ...
        for inithour in ${inithours} ; do
            for hr in ${lead_hours} ; do
                COMINfilename="${COMINgfs}/${inithour}/wave/gridded/gfswave.t${inithour}z.global.0p25.f${hr}.grib2"
                DATAfilename="${DATA}/gfswave.${INITDATE}.t${inithour}z.global.0p25.f${hr}.grib2"
                COMOUTfilename="$COMOUT.${INITDATE}/${MODEL}/gfswave.${INITDATE}.t${inithour}z.global.0p25.f${hr}.grib2"
