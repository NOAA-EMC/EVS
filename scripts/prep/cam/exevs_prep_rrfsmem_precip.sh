...
# =============================================================================
#
# NAME: exevs_prep_rrfsmem_precip.sh
# CONTRIBUTOR(S): Marcel Caron, marcel.caron@noaa.gov, NOAA/NWS/NCEP/EMC-VPPPGB
# PURPOSE: Handle all components of an EVS REFS Member Precipitation - Prepare job
...
# Run all REFS Member precip/prep Reformat jobs
