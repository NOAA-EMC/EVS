#PBS -N jevs_cmc_regional_atmos_grid2grid_stats_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=00:10:00
#PBS -l place=vscatter,select=1:ncpus=11:ompthreads=1:mem=5GB
#PBS -l debug=true
#PBS -V
...
export job=${PBS_JOBNAME:-jevs_cmc_regional_atmos_grid2grid_stats}
...
export COMINcmc_regional=$COMIN/prep/$COMPONENT/$RUN
