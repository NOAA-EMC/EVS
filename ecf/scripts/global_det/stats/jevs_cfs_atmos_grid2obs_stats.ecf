#PBS -N jevs_cfs_atmos_grid2obs_stats_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=00:45:00
#PBS -l place=vscatter,select=1:ncpus=28:ompthreads=1:mem=15GB
#PBS -l debug=true
#PBS -V
...
export job=${PBS_JOBNAME:-jevs_cfs_atmos_grid2obs_stats}
