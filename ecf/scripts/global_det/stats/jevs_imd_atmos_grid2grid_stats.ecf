#PBS -N jevs_imd_atmos_grid2grid_stats_00
#PBS -j oe
#PBS -S /bin/bash
#PBS -q dev
#PBS -A VERF-DEV
#PBS -l walltime=00:20:00
#PBS -l place=vscatter,select=1:ncpus=43:ompthreads=1:mem=25GB
#PBS -l debug=true
#PBS -V
...
export job=${PBS_JOBNAME:-jevs_imd_atmos_grid2grid_stats}
...
export COMINimd=$COMIN/prep/$COMPONENT/$RUN
export COMINghrsst_ospo=$COMIN
...
#          atmospheric grid-to-grid component for IMD/NCMRWF
######################################################################
